...
public class GvrHead : MonoBehaviour, IKopfRotationsInjektion {
  ...
  private void UpdateHead() {
    ...
    if (trackRotation)
    {
      ...
      // Injektion der Kopf-Rotation aus der AUTU Umgebung
      if (KomponenteAktiv)
      {
        rot = TestKopfRotation;
      }
  ...
  #region IKopfRotationsInjektion

  Quaternion TestKopfRotation;
  bool IstKomponenteAktiv = false;

  public Quaternion KopfRotation
  {
    get
    {
      if (KomponenteAktiv)
      {
        return TestKopfRotation;
      }
      else
      {
  ...
  public bool KomponenteAktiv
  {
    ...
    set
    {
      ...
      {
        TestKopfRotation = GvrViewer.Instance.HeadPose.Orientation;
      }
    }
  }
